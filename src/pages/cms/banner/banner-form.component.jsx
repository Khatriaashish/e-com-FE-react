    ...
    return (<>
        <Form onSubmit={handleSubmit(submitForm)}>
            <Form.Group className="row mb-3 text-center">
                ...
                <Col sm={9}>
                    <Form.Control type="text" placeholder="Enter Banner Title..." size="sm" {...register("title", {required: true})}/>
            ...
            <Form.Group className="row mb-3 text-center">
                ...
                <Col sm={9}>
                    <Form.Control type="url" placeholder="Enter link" size="sm" {...register("url", {required: false})}/>
